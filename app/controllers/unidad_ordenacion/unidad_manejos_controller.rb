class UnidadOrdenacion::UnidadManejosController < ApplicationController
  ...
  private
    ...
    def unidad_manejo_params
      params.require(:unidad_manejo).permit(:nombre, :abreviado, :bloque_ordenacion_id, :nro_providencia, :fecha_otorgamiento, :fecha_vencimiento, :area, :ubicacion, :descripcion, :doc_providencia, :doc_plan_forestal, :tipo_bosque_id, municipio_ids:[])
    end
end